    ...
    <div class="container">
        <div class="row">
            ...
            <div class="headings-text headings-text--dark">
                ...
                <h1 class="headings-text__big headings-text__big--size-medium"><?php the_field('big-heading', 'options'); ?></h1>
                <h3 class="headings-text__small-below"><?php the_field('small-heading', 'options'); ?></h3>
                <p class="headings-text__paragraph"><?php the_field('paragraph', 'options'); ?></p>
                <a href="<?php the_field('button-1__url', 'options'); ?>" class="button button--white-with-shadow button--width-narrow"><?php the_field('button-1__text', 'options'); ?></a>
            </div>
